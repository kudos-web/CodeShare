<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ContentWithLeftBlockquoteAndButton.ascx.cs" Inherits="CMSWebParts_Custom_ContentWithLeftBlockquoteAndButton" %>
