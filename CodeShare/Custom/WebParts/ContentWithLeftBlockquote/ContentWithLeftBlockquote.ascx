<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ContentWithLeftBlockquote.ascx.cs" Inherits="CMSWebParts_Custom_ContentWithLeftBlockquote_ContentWithLeftBlockquote" %>
