<%@ Control Language="C#" AutoEventWireup="true" Inherits="Custom_FormControls_ImageCropperTool_AdminControls_CustomBaseImageEditor" CodeFile="CustomBaseImageEditor.ascx.cs" %>
<%@ Register Src="~/CMSModules/AdminControls/Controls/MetaFiles/MetaDataEdit.ascx" TagName="MetaDataEditor" TagPrefix="cms" %>

<div class="image-editor-menu-column" style="display: none">
                    ...
                    <asp:Panel ID="pnlCrop" runat="server" DefaultButton="btnCrop">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="editing-form-value-cell">
                                    <cms:CMSTextBox ID="txtCropWidth" runat="server" CausesValidation="true" CssClass="input-width-20 input-number" MaxLength="5" Text="200" />
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="editing-form-label-cell">
                                ...
                                <div class="editing-form-value-cell">
                                    <cms:CMSTextBox ID="txtCropHeight" runat="server" CausesValidation="true" CssClass="input-width-20 input-number" MaxLength="5" Text="200" />
                                </div>
                            </div>
                            <div class="form-group">
...
<div class="image-editor-image-column" style="width: 100%">
    <cms:MessagesPlaceHolder ID="plcMess" runat="server" UseRelativePlaceHolder="false" />
    <iframe id="frameImg" name="imageFrame" scrolling="auto" runat="server" class="image-editor-frame" style="position: absolute !important; width: 100%; height: 100%" />
    <asp:Image ID="imgMain" runat="server" Visible="false" CssClass="editing-image" />
    <asp:Button ID="btnCustomCrop" runat="server" CssClass="EditingFormMediaPathClearButton btn btn-default btnCustomCrop" Text="Crop" OnClick="btnCropClick" />
    <asp:HiddenField ID="hdnCropWidth" runat="server" />
    <asp:HiddenField ID="hdnCropHeight" runat="server" />
    <asp:HiddenField ID="hdnAllowResize" runat="server" />
</div>
...
<script type="text/javascript" language="javascript">
    ...
    var getAllowResize = '<%= hdnAllowResize.Value.ToString().ToLower() %>';
    var getCropWidth = '<%= hdnCropWidth.Value.ToString().ToLower() %>';
    var getCropHeight = '<%= hdnCropHeight.Value.ToString().ToLower() %>';

    //]]>
</script>

<style>
    .image-editor-image-column .btnCustomCrop {
        position: absolute;
        bottom: 16px;
        left: 172px;
        z-index: 9999;
