<%@ Page Language="C#" AutoEventWireup="true" Inherits="Custom_FormControls_ImageCropperTool_Modules_CustomImageEditor"
    MasterPageFile="~/CMSMasterPages/UI/Dialogs/ModalDialogPage.master" Title="Edit image"
    Theme="Default" CodeFile="CustomImageEditor.aspx.cs" %>

<%@ Register Src="~/Custom/FormControls/ImageCropperTool/Modules/CustomImageEditor.ascx" TagName="ImageEditor" TagPrefix="cms" %>
